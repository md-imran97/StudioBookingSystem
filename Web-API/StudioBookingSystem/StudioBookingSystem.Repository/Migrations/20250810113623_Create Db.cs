        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Amenities_Studios_StudioId",
                        column: x => x.StudioId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_Studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "Studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "Studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "Studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudioImages_Studios_StudioId",
                        column: x => x.StudioId,
                        principalTable: "Studios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coordinates_Locations_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amenities_StudioId",
                table: "Amenities",
                column: "StudioId");

            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_StudioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_StudioId",
                table: "Contacts",
                column: "StudioId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Locations_StudioId",
                table: "Locations",
                column: "StudioId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudioImages_StudioId",
                table: "StudioImages",
                column: "StudioId");
